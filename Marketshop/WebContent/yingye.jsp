...
<head>
<base href="<%=basePath%>">
<title>My JSP 'yingye.jsp' starting page</title>
<meta charset="utf-8">
...
<div id="shopping">
  <table>
    ...
    <tr>
      ...
      <td class="number"><%=s.getS_SELLNUM() %></td>
      <td class="price" id="price_id_1"><%=s.getS_TOTAL() %></td>
  ...
  <br>
  <div class="submit">
    <input type="submit" value="返回" onclick="javascript:document.location.href='first.jsp'" />
  </div>
  <div class="submit">
    <input type="submit" value="员工营业记录" onclick="javascript:document.location.href='cartEMs.jsp'" />
  </div>
  <div class="submit">
    <input type="submit" value="商品销售记录" onclick="javascript:document.location.href='cartGoods.jsp'" />
  </div>
  <div class="submit">
    <input type="submit" value="某天营业记录" onclick="javascript:document.location.href='cartTimes.jsp'" />
  </div>
</div>
</body>
</html>
