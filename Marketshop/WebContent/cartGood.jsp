...
<html>
  <head>
    ...
    <title>My JSP 'cartGood.jsp' starting page</title>
  ...
  <body>
   ...
   <div id="shopping">
			...
			<table>
			   ...
			   <%  CartDao cart = new CartDao();
                    ...
                    if(list!=null&&list.size()>0)
                   {
	                    ...
	                    {
	                        Cart s = list.get(i);
	                        if(s.getS_ID().equals(request.getParameter("s_id")))
	                        {
			...
			<tr>
			 ...
			 %>
			<div class="submit"><input type="submit" value="查询" onclick="javascript:document.location.href='cartGoods.jsp'" /></div>
