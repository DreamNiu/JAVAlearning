...
<html>
  <head>
    ...
    <title>My JSP 'cartTime.jsp' starting page</title>
			...
			<table>
			   ...
			   <%  CartDao cart = new CartDao();
                    ...
                    if(list!=null&&list.size()>0)
                   {
	                    ...
	                    {
	                        Cart s = list.get(i);
				            if(s.getS_TIME().equals(request.getParameter("time")))
				            {
				     %> 
			<tr>
			 ...
			 %>
			<div class="submit"><input type="submit" value="查询" onclick="javascript:document.location.href='cartTimes.jsp'" /></div>
