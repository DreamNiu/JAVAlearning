...
<html>
  <head>
    ...
    <title>My JSP 'modifyGoodswork.jsp' starting page</title>
  ...
  <body>
    <%
		 ...
		 Goods g = go.modifyGoods(request.getParameter("s_id"), new String(request.getParameter("s_name").getBytes("ISO-8859-1"),"UTF8"),   request.getParameter("s_biao"),
