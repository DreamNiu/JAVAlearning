			...
			<table>
				...
				<tr>
					...
					<td><input type="text" name="imageValue" size="50px"
						id="imageValue" class="input" value="${verifyCode }"></td>
				...
				<tr>
					<td></td>
					<td colspan="2"><label class="checkbox"><input
							id="remember" name="remember" type="checkbox" value="remember-me">记住我一周
							&nbsp;&nbsp;&nbsp;&nbsp; </label></td>
					<td></td>
				</tr>
				<tr>
					...
					<td><button type="submit" class="btn btn-primary">登陆</button>
						<input type="reset" class="btn btn-primary" value="重写" /></td>
					<td></td>
				</tr>
			</table>
		</form>
